    ...
    <?php if(isset($lib->isbn)):?>
        ...
        <div id="datosLibro">
            ...
            <div class="botonLibIndividual">
                <a href="<?=base_url?>libro/vista&isbn=<?=$lib->isbn?>"><div class="boton btnAcciones">Vista previa</div></a>
                <a href="<?=base_url?>carrito/add&isbn=<?=$lib->isbn?>"><div class="boton btnAcciones">Comprar</div></a>
            </div>
        </div>
        <div id="clear"></div>
        <div id="description">
